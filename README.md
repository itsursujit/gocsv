...
```shell
curl -s https://raw.githubusercontent.com/itsursujit/gocsv/latest/scripts/install-latest-darwin-amd64.sh | bash
```
...
For the latest pre-built binaries, see the [Latest Release](https://github.com/itsursujit/gocsv/releases/tag/latest) page.
...
```shell
/bin/bash <(curl -s https://raw.githubusercontent.com/itsursujit/gocsv/latest/scripts/install-latest-darwin-amd64.sh)
```
